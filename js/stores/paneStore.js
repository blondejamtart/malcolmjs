...
var dropdownMenuSelect = function (tab)
  ...
  console.log("paneStore.dropdownMenuSelect()");
  console.log(tab);
...
function setBlockTabStateTrue(BlockId)
  {
  console.log('paneStore.setBlockTabStateTrue()')
...
function setFavTabStateTrue()
  {
  console.log('paneStore.setFavTabStateTrue()')
...
function setConfigTabStateTrue()
  {
  console.log('paneStore.setConfigTabStateTrue()')
...
function setBlockLookupTableTabStateTrue()
  {
  console.log('paneStore.setBlockLookupTableTabStateTrue()')
